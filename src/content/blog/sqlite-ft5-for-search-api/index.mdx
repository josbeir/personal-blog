...
date: 2025-12-03
tags: [SQLite, FTS5, Drupal, SearchAPI, Performance, Benchmarks]
...
The module is well-tested and actively developed. You can find the module page, installation instructions, and documentation at **[www.drupal.org/project/search_api_sqlite](https://www.drupal.org/project/search_api_sqlite)**. The source code is available for review and contribution at **[git.drupalcode.org/project/search_api_sqlite](https://git.drupalcode.org/project/search_api_sqlite)**.
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **SQLite FTS5** | None | **BM25 (High)** | Small/Medium Sites (&lt;500K items) | Limited (via tokenizers) | No |
| **Database Search** | None | Basic Frequency (Low) | Very Simple Search | No | No |
| **Solr** | Server (JVM) | BM25 (High) | Large Scale, Advanced Data Models | **Yes (Robust)** | **Yes** |
| **Elasticsearch** | Server (JVM/API) | BM25 (High) | Large Scale, Analytics, Logging | **Yes (Robust)** | No |
