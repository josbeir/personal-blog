	...
	<div class="navbar max-w-7xl mx-auto px-4 lg:px-8">
		<div class="navbar-start">
			<div class="dropdown lg:hidden">
				...
				<ul tabindex="0" class="menu menu-sm dropdown-content mt-3 z-1 p-2 bg-base-100 rounded-box w-52 border border-base-content/10">
...
<main class="max-w-7xl mx-auto p-6 lg:p-10" s:block="content">
